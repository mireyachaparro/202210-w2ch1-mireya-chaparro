...
const showRanking = () => {
    ...
    console.log("-------RANKING-------");
    rankingUser.forEach((user)=>console.log(`Nombre: ${user.nombre} Acertadas: ${user.acertadas}`));
    console.log("---------------------");
};
...
const checkIfCorrect = () => {
    ...
    console.log(`Has acertado ${correctas} palabras. Has fallado ${validWords.length-correctas}`);
    return correctas;
};
