...
export const showFlights = () => {
    ...
    flights.forEach((flight) => {
        if (flight.scale) {
            console.log(
                `Id: ${flight.id}. El vuelo con origen: ${flight.from}, y destino: ${flight.to} tiene un coste de ${flight.cost}€ y efectua escala`
            );
        } else {
            console.log(
                `Id: ${flight.id}. El vuelo con origen: ${flight.from}, y destino: ${flight.to} tiene un coste de ${flight.cost}€ y NO efectua escala`
            );
        }
    });
    console.log('---------------------');
...
export const adminAction = () => {
    ...
    if (action === 'crear') {
        ...
        newFlight.scale = prompt(
            'Ingresa SI si tiene escala, si no tiene escala dejar en blanco'
        );
